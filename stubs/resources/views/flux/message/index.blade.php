...
<ui-message
    ...
    wire:ignore
>
    <div id="flux-message-container" class="flex flex-col gap-3 pointer-events-auto"></div>
...
<script>
    if (! customElements.get('ui-message')) {
        customElements.define('ui-message', class extends HTMLElement {
            showmessage(detail) {
